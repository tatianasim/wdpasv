Feature: Auth
  ...
  Scenario Outline: As a user, I must see validation error if email field was cleared
  ...
  Scenario Outline: As a user, I must see validation error if password field was cleared
